...
var parsedData = JSON.stringify(jsondata);
 ...
 var articlesArray=[];
 articlesArray=obj.articles;
 console.log(articlesArray);

 for(var ans in articlesArray)
 {
   delete  articlesArray[ans].url;
   delete  articlesArray[ans].urlToImage;
   delete  articlesArray[ans].publishedAt;
 }
 console.log(articlesArray);